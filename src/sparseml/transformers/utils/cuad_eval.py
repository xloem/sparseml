                        ...
                        "prediction_text": datasets.features.Sequence(
                            {
                                ...
                                "start_logit": datasets.Value("float"),
                                "end_logit": datasets.Value("float"),
                            }
                        ),
                    },
                    "references": {
                ...
                preds.append(
                    {
                        ...
                        "start_logit": prediction["prediction_text"]["start_logit"][i],
                        "end_logit": prediction["prediction_text"]["end_logit"][i],
                    }
                )
